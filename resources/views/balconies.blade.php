...
@section('title')
    Остекление балконов и лоджий во Владивостоке, Артёме, Уссурийске от производителя | Оконный Завод
@endsection

@section('descriprion')
    Панорамное остекление балконов и лоджий от производителя, качественная отделка, скидки, акции от 8300 рублей за м2
@endsection
...
@section('content')
    <main>
        <section class="white-sec products">
            <h2>Балконы</h2>
                ...
                <div class="products__content">
                    <div class="products__wrapper">
                        <div class="products__item">
                            <picture>
                                <img src="/img/balconies/balcon.webp" alt="photo">
                            </picture>
        ...
        <section class="pink-sec types">
            ...
            <div class="container">
                <h2>
                    Отделка лождий «под ключ»
                </h2>
                <div class="sub-title">
                    Мы выполняем отделку балконов под ключ. Наши специалисты сделают замеры, разработают дизайн, проведут
                    работы по отделке и приберут за собой.
                </div>
                <div class="types__content">
                    <div class="type">
                        <div class="type__title">
                            <h3>1. Внешняя отделка</h3>
                        </div>

                        <div class="type__short-desc">
                            Внешняя отделка защищает балкон от негативных природных воздействий: неблагоприятной
                            температуры, осадков, ветра, пыли, а также придает балкону или лоджии привлекательный внешний
                            вид.
                        </div>

                        <ul class="type__list">
                            <li>Установка винилового сайдинга</li>
                            <li>Установка теплосберегающих
                                панелей Ханьи
                            </li>
                            <li>Установка винилового сайдинга</li>
                            <li>Установка винилового сайдинга</li>
        ...
        <section class="white-sec colors">
            <h2>Цвет отделки балконов</h2>
            <form action="" class="colors__m-choice">
                <input checked type="radio" name="m-choice" id="inner">
                <label for="inner">ВНЕШНЯЯ ОТДЕЛКА</label>

                <input type="radio" name="m-choice" id="outer">
                <label for="outer">ВНУТРЕННЯЯ ОТДЕЛКА</label>
            </form>
            <div class="slide-container">
                ...
                <div class="colors__content">
                    <div class="colors__info">
                        ...
                        <div class="colors__choice">
                            <h4>ВИНИЛОВЫЙ САЙДИНГ</h4>
                            <div class="colors__color active">
                                <picture>
                                    <img src="/img/balconies/color-01.webp" alt="color">
                                </picture>
                            </div>
                        ...
                        <div class="btn">бесплатный замер</div>
                    </div>

                    <div class="colors__show">
                        <div class="colors__item">
                            <picture>
                                <img src="/img/balconies/photo-product.webp" alt="product">
                            </picture>

                            <div class="colors__item-info">
                                <div class="colors__property">
                                    <div class="colors__property-title">Цвет</div>
                                    <div class="colors__property-desc">Шампань</div>
                                </div>

                                <div class="colors__property">
                                    <div class="colors__property-title">Срок установки</div>
                                    <div class="colors__property-desc">От 7 дней</div>
                                </div>
                            </div>
                        </div>

                        <div class="colors__item invis">
                            <picture>
                                <img src="/img/balconies/photo-product.webp" alt="product">
                            </picture>
        ...
        <section class="balconies__services services old-sec white-sec">
            <div class="container">
                <h2>Возможности остекления</h2>
                <div class="services-content">
                    <div class="services__tabs">
                        <div class="tab tab-active" id="service-tab-1"><span>Теплый пол</span></div>
                        <div class="tabs-line" id="tab-line-2"></div>
                        <div class="tab" id="service-tab-2"><span>Настил пола</span></div>
                        <div class="tabs-line" id="tab-line-3"></div>
                        <div class="tab" id="service-tab-3"><span>Утепление</span></div>
                    </div>
                        ...
                        <div class="slide">
                            <div class="services__capability">
                                <div class="service__main">
                                    <h3>Утепление</h3>
                                    <p>Обшивка стен, пола, потолка всегда начинается с утепления. В качестве утеплителя мы
                                        предлагаем два вида материала: ПСБ-С и Изопинк.</p>
                                ...
                                <div class="service__list">
                                    <ul>
                                        <li>
                                            <h4>ПСБ-С</h4>
                                            <p>Теплоизоляционный материал, который широко применяется для отделки стен и
                                                потолков. Он долговечен, имеет низкое водопоглощение, обладает тепло- и
                                                звукоизоляционными свойствами, экономичен по цене.</p>
                                        </li>
                                        <li>
                                            <h4>Изопинк</h4>
                                            <p>Это новый представитель среди теплоизоляционных материалов. Имеет самый
                                                низкий коэффициент теплопроводности среди утеплителей. А высокая прочность и
                                                жесткость позволяет применять его для утепления фасадов, крыш, полов,
                                                взлетных полос на аэродромах</p>
                                        </li>
        ...
        <section class="balconies__options options pink-sec">
                ...
                <div class="options-content options-slider">
                    <div class="slide">
                        <div class="options__card" id="card-1">
                            <div class="card-image">
                                <img src="/img/balconies/hanger-icon.webp">
                            </div>
                    ...
                    <div class="slide">
                        <div class="options__card" id="card-2">
                            <div class="card-image">
                                <img src="/img/balconies/idea-icon.webp">
                            </div>
                    ...
                    <div class="slide">
                        <div class="options__card" id="card-3">
                            <div class="card-image">
                                <img src="/img/balconies/roof-icon.webp">
                            </div>
                    ...
                    <div class="slide">
                        <div class="options__card" id="card-4">
                            <div class="card-image">
                                <img src="/img/balconies/blind-icon.webp">
                            </div>
        ...
        <section class="balconies__examples examples old-sec white-sec">
            <div class="container">
                <h2>Примеры работ</h2>
