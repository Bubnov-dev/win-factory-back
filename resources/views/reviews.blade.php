...
@section('content')
    <main>
        <div class="container">
            ...
            <h2 class="h2">Отзывы о нашей компании</h2>
                    ...
                    <div class="reviews-item">
                        <div class="reviews__photo">
                            <picture>
                                ...
                                <img src="{{  $data[$i]['images'][0] }}" alt="reviews__photo"/></picture>
                        </div>
                        <div class="reviews__header">
                            <h4 class="reviews__name">{{ $data[$i]['name'] }}</h4>
                            <div class="reviews__city">{{ $data[$i]['city'] }}</div>
                            <div class="reviews__date">{{ $data[$i]['date'] }}</div>
                        </div>
                        ...
                        <a href="/reviews/{{ $data[$i]['id'] }}" class="btn reviews__btn">Подробнее</a>
                    </div>
                @endfor
            </div>
        </div>
